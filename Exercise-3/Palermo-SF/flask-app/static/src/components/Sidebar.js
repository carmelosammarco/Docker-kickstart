  ...
  render() {
        ...
        <div>
          <div id="search-area">
            <form onSubmit={this.handleSearch}>
              <input type="text" value={this.state.query} onChange={this.onChange} placeholder="Panelle,Crocche,Milza or Sfincione?"/>
    ...
    return (
      <div>
        <div id="search-area">
          <form onSubmit={this.handleSearch}>
            <input type="text" value={query} onChange={this.onChange} placeholder="Panelle,Crocche,Milza or Sfincione?"/>
            <button>Search!</button>
          </form>
        </div>
        {resultsCount > 0 ? (
